                  ...
                  <div className="block sm:hidden">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-slate-900 text-sm">{session.distance} yds</p>
                        </div>
                        <div>
                          <p className="text-slate-500 text-xs">Rifle</p>
                          <p className="font-medium text-slate-900 text-sm truncate">{session.rifle}</p>
                        </div>
                        <div>
                          <p className="text-slate-500 text-xs">Calibre</p>
                          <p className="font-medium text-slate-900 text-sm">{session.calibre}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-end space-x-2 pt-2 border-t border-slate-100">
                      ...
                      <Button
                        ...
                        className="px-3 py-2 h-8 text-red-600 hover:text-red-700 hover:bg-red-50"
                      >
